...
| MSD-4 | Hall soundness: no injective digit choice ⇒ no nice n in the range | `Nice.no_nice_of_not_hasSDR` | `common/src/msd_prefix_filter.rs::has_distinct_assignment` | brute-force b 4–16 | proved | 3 |
